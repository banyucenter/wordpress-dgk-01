...
class Xooapp_Nav_Menu extends Widget_Base {

	protected $nav_menu_index = 1;

	public function get_name() {
		return 'xooapp-nav-menu';
	}

	public function get_title() {
		return __( 'Nav Menu', 'xooapp' );
	}
	...
	protected function _register_controls() {
		...
		if ( ! empty( $menus ) ) {
			...
			$this->add_control(
				...
				[
					...
					'raw' => sprintf( __( '<strong>There are no menus in your site.</strong><br>Go to the <a href="%s" target="_blank">Menus screen</a> to create one.', 'xooapp' ), admin_url( 'nav-menus.php?action=edit&menu=0' ) ),
					'separator' => 'after',
		...
		$this->add_control(
			...
			[
				...
				'default' => 'horizontal',
				'options' => [
					'horizontal' => __( 'Horizontal', 'xooapp' ),
					'vertical' => __( 'Vertical', 'xooapp' ),
					'dropdown' => __( 'Dropdown', 'xooapp' ),
				],
		...
		$this->add_control(
			'pointer',
			[
				'label' => __( 'Pointer', 'xooapp' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'underline',
				'options' => [
					'none' => __( 'None', 'xooapp' ),
					'underline' => __( 'Underline', 'xooapp' ),
					'overline' => __( 'Overline', 'xooapp' ),
					'double-line' => __( 'Double Line', 'xooapp' ),
					'framed' => __( 'Framed', 'xooapp' ),
					'background' => __( 'Background', 'xooapp' ),
					'text' => __( 'Text', 'xooapp' ),
				],
				'condition' => [
					'layout!' => 'dropdown',
		...
		$this->add_control(
			'indicator',
			[
				'label' => __( 'Submenu Indicator', 'xooapp' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'classic',
				'options' => [
					'none' => __( 'None', 'xooapp' ),
					'classic' => __( 'Classic', 'xooapp' ),
					'chevron' => __( 'Chevron', 'xooapp' ),
					'angle' => __( 'Angle', 'xooapp' ),
					'plus' => __( 'Plus', 'xooapp' ),
				],
		...
		$this->add_control(
			...
			[
				'label' => __( 'Mobile Dropdown', 'xooapp' ),
		...
		$this->add_control(
			'dropdown',
			[
				'label' => __( 'Breakpoint', 'xooapp' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'tablet',
				'options' => [
					/* translators: %d: Breakpoint number. */
					'mobile' => sprintf( __( 'Mobile (< %dpx)', 'xooapp' ), $breakpoints['md'] ),
					/* translators: %d: Breakpoint number. */
					'tablet' => sprintf( __( 'Tablet (< %dpx)', 'xooapp' ), $breakpoints['lg'] ),
				],
		...
		$this->add_control(
			'full_width',
			[
				'label' => __( 'Full Width', 'xooapp' ),
				'type' => Controls_Manager::SWITCHER,
				'description' => __( 'Stretch the dropdown of the menu to full width.', 'xooapp' ),
		...
		$this->add_control(
			...
			[
				...
				'default' => 'aside',
				'options' => [
					'aside' => __( 'Aside', 'xooapp' ),
					'center' => __( 'Center', 'xooapp' ),
				],
		...
		$this->add_control(
			'toggle',
			[
				'label' => __( 'Toggle Button', 'xooapp' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'burger',
				'options' => [
					'' => __( 'None', 'xooapp' ),
					'burger' => __( 'Hamburger', 'xooapp' ),
				],
		...
		$this->add_responsive_control(
			...
			[
				'label' => __( 'Horizontal Padding', 'xooapp' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'max' => 50,
		...
		$this->add_responsive_control(
			...
			[
				'label' => __( 'Vertical Padding', 'xooapp' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'max' => 50,
		...
		$this->add_control(
			...
			[
				'raw' => __( 'On desktop, this will affect the submenu. On mobile, this will affect the entire menu.', 'xooapp' ),
				'type' => Controls_Manager::RAW_HTML,
	...
	protected function render() {
		...
		<script>
			jQuery(".eicon").toggle(function () {
			    jQuery(".elementor-nav-menu--toggle .elementor-menu-toggle:not(.elementor-active)+.elementor-nav-menu__container").css({"display": "block"});
			}, function () {
			    jQuery(".elementor-nav-menu--toggle .elementor-menu-toggle:not(.elementor-active)+.elementor-nav-menu__container").css({"display": "none"});
			});
		</script>
		<?php
	}
