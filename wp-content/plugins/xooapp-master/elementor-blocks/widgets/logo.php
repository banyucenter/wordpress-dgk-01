...
class Xooapp_Logo extends Widget_Base {
	...
	public function get_title() {
		return 'Xooapp Logo'; // title to show on xooapp
	}

	public function get_icon() {
		return 'eicon-site-logo';    //   eicon-posts-ticker-> eicon ow asche icon to show on elelmentor
	}
	...
	protected function _register_controls() {
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .xooapp-logo-desc, {{WRAPPER}} .xooapp-logo-desc p',
