 ...
 *
 */
class XOOAPPFramework_Option_Sorter extends XOOAPPFramework_Options {
  ...
  public function output(){
    ...
    $enabled_title  = ( isset( $this->field['enabled_title'] ) ) ? $this->field['enabled_title'] : esc_html__( 'Enabled Modules', 'xooapp' );
    $disabled_title = ( isset( $this->field['disabled_title'] ) ) ? $this->field['disabled_title'] : esc_html__( 'Disabled Modules', 'xooapp' );

    echo '<div class="xooapp-modules">';
    echo '<h3>'. $enabled_title .'</h3>';
    echo '<ul class="xooapp-enabled">';
    if( ! empty( $enabled ) ) {
