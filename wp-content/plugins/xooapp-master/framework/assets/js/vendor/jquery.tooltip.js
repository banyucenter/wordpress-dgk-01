...
+function ($) {
  ...
  CSTooltip.DEFAULTS = {
    ...
    placement: 'top',
    selector: false,
    template: '<div class="xooapp-tooltip" role="tooltip"><div class="xooapp-tooltip-arrow"></div><div class="xooapp-tooltip-inner"></div></div>',
    trigger: 'hover focus',
    title: '',
    delay: 0,
    html: false,
  ...
  CSTooltip.prototype.setContent = function () {
    ...
    $tip.find('.xooapp-tooltip-inner')[this.options.html ? 'html' : 'text'](title)
  ...
  CSTooltip.prototype.arrow = function () {
    return (this.$arrow = this.$arrow || this.tip().find('.xooapp-tooltip-arrow'))
  }
