...
<div id="single-post-page" class="single-post-section">
	<div class="container">
		<div class="row">
			...
			<main id="primary" class="site-main post-holder p-right-60 col-md-12 col-lg-9">
				<?php if ( have_posts() ) : ?>
...
?>
<footer id="footer-1" class="p-bottom-60 footer division" <?php echo wp_kses_stripslashes( $footer_bg ) ?>>
