...
?>
<footer id="footer-1" class="p-bottom-60 footer division" <?php echo wp_kses_stripslashes( $footer_bg ) ?> itemscope="itemscope" itemtype="http://schema.org/WPFooter">
			...
			<div class="row">
				<div class="col-md-5">	
					<div class="row footer-copyright">
						...
						<?php echo wpautop( xooapp_get_option( 'copyrights' ) ); ?>

					</div>	

				</div>
				<div class="col-md-7">
					<div class="row footer-links text-right">
						<?php
